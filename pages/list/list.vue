			...
			<scroll-view scroll-y="true">
				...
				<view class="list-music">
					<view v-show="isShow" class="list-music-title">
						...
						<text class="text-play">播放全部</text>
						<text class="text-all">(共{{ playlist.trackCount }}首)</text>
					</view>
					<view class="list-music-item" v-for="(item,index) in playlist.tracks" :key="item.id"
						...
						<view class="list-music-song">
							<view>{{ item.name }}</view>
							<view>
								<image v-if="item.l.br == 128000" src="../../static/sq.png" mode=""></image>
...
<style lang="scss" scoped>
	...
	.list-music-title {
		height: 58rpx;
		line-height: 58rpx;
		margin: 30rpx 30rpx 58rpx 30rpx;
	}
